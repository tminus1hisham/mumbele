...
<v-container>
    <v-row>
        <v-col cols="6" md="3" v-for = 'item in products'  :key="item.id"
>
            <v-card title="{{ item.name }}" subtitle="Subtitle">
                <v-row>
                  <v-col >
                    <v-img  :src="item.image" height="100"></v-img>
                    <v-card-title>{{ item.name }}</v-card-title>
                    
                        <v-chip class="ml-3">{{ item.category }}</v-chip>

                      
                   <v-card-text>Ksh {{ item.price }}</v-card-text>
                  </v-col>
                </v-row>
            </v-card>
            <v-img
...
const products = menuStore.menu;

// const products = ref([
//   // ACCESSORIES
//   { id:1, image:"/place.png", category:"Accessories", name:"Thread Seal Tape (Small)", price:55 },
//   { id:2, image:"/place.png", category:"Accessories", name:"Thread Seal Tape (Large)", price:95 },
//   { id:3, image:"/place.png", category:"Accessories", name:"PVC Solvent Cement 250ml", price:420 },
//   { id:4, image:"/place.png", category:"Accessories", name:"PVC Solvent Cement 500ml", price:690 },
//   { id:5, image:"/place.png", category:"Accessories", name:"Silicone Sealant 280ml", price:350 },
//   { id:6, image:"/place.png", category:"Accessories", name:"Rubber Washer Kit (Mixed)", price:260 },
//   { id:7, image:"/place.png", category:"Accessories", name:"Pipe Jointing Compound", price:310 },
...
//   // PLUMBING TOOLS
//   { id:11, image:"/place.png", category:"Plumbing Tools", name:"Tape Measure 5m", price:150 },
...
//   { id:21, image:"/place.png", category:"PPR", name:"PPR Pipe 20mm (4m)", price:240 },
//   { id:22, image:"/place.png", category:"PPR", name:"PPR Pipe 25mm (4m)", price:350 },
//   { id:23, image:"/place.png", category:"PPR", name:"PPR Pipe 32mm (4m)", price:540 },
//   { id:24, image:"/place.png", category:"PPR", name:"PPR Pipe 40mm (4m)", price:890 },
//   { id:25, image:"/place.png", category:"PPR", name:"PPR Pipe 50mm (4m)", price:1_400 },
